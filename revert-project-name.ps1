...
Write-Host "Reverting project name from '$oldName' to '$newName'..." -ForegroundColor Cyan
    ...
    try {
        ...
        if ($content -and $content -match $oldName) {
            ...
            if ($originalContent -ne $newContent) {
                ...
                $message = "Reverted: $relativePath ($count replacements)"
...
Write-Host ""
Write-Host "Done! Project name reverted to '$newName'." -ForegroundColor Cyan
